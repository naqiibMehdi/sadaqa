...
@section('title', 'Modifier le status de la demande')

@section('content')
  <div class="mb-6">
    <div class="flex justify-between items-center">
      <div>
        <h1 class="text-3xl font-bold text-gray-800">Modifier le status</h1>
        <p class="text-gray-600">Modification des informations de la demande numéro: {{$contact->id}}</p>
      </div>
    ...
    <div class="bg-white rounded-lg shadow-md">
      <div class="p-6 border-b">
        <h2 class="text-xl font-semibold text-gray-800">
          <i class="fas fa-edit mr-2"></i>Informations du status de la demande
        </h2>
      </div>
