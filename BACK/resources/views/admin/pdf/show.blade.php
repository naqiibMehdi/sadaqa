          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div class="p-3 bg-gray-50 rounded-lg">
                <p
                  class="text-gray-800 font-medium">{{ $pdf->user->name }} {{ $pdf->user->first_name }}</p>
              </div>
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Cagnotte</label>
              <div class="p-3 bg-gray-50 rounded-lg">
                <p class="text-gray-800 font-medium">{{ $pdf->campaign->title }}</p>
              </div>
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Adresse IP</label>
              <div class="p-3 bg-gray-50 rounded-lg">
                <p class="text-gray-800">{{ $pdf->ip_address }}</p>
              </div>
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Agent Utilisateur</label>
              <div class="p-3 bg-gray-50 rounded-lg">
                <p class="text-gray-800">{{ $pdf->user_agent }}</p>
              </div>
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Date Téléchargement</label>
              <div class="p-3 bg-gray-50 rounded-lg">
                <p class="text-gray-800">{{ $pdf->downloaded_at->format("d/m/Y") }}</p>
              </div>
            </div>
          </div>
        </div>
