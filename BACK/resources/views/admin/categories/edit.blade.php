  ...
  <div class="mb-6">
    <div class="flex justify-between items-center">
      <div>
        ...
        <p class="text-gray-600">Modification de la catégorie</p>
      </div>
    ...
    <div class="bg-white rounded-lg shadow-md">
      <div class="p-6 border-b">
        <h2 class="text-xl font-semibold text-gray-800">
          <i class="fas fa-edit mr-2"></i>Informations de la catégorie numéro #{{ $category->id }}
        </h2>
      </div>
        ...
        <div class="grid grid-cols-1 gap-6">
          ...
          <div>
            ...
            <input type="text"
                   id="translate_name"
                   name="translate_name"
                   value="{{ old('translate_name', $category->translate_name) }}"
